...
void test_meta (void)
{
    ...
    ok (flux_sigcert_meta_setb (cert, "booles-a-fool", true) == 0,
        "flux_sigcert_meta_setd booles-a-fool=true");
    ...
    ok (flux_sigcert_meta_getb (cert, "booles-a-fool", &b) == 0 && b == true,
        "flux_sigcert_meta_getb booles-a-fool works");
